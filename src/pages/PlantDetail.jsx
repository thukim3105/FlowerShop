  ...
  if (!product) {
    return (
      <main className="min-h-[60vh] px-6 py-24 text-center sm:px-10">
        <h1 className="font-serif text-3xl text-[#1b1c1a]">Plant not found</h1>
        <p className="mt-4 text-sm leading-7 text-[#5b6c57]">
          The plant you are looking for does not exist or has been removed.
        </p>
        <Link
          to="/plants"
          className="mt-8 inline-flex rounded-full bg-[#2b6954] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#244f3c]"
        >
          Return to plants
        </Link>
      </main>
